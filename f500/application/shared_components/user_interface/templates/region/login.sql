...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6139866735338951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6140104334338951)
,p_plug_template_id=>wwv_flow_imp.id(6139866735338951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6140495255338951)
,p_plug_template_id=>wwv_flow_imp.id(6139866735338951)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6140706261338953)
,p_plug_template_id=>wwv_flow_imp.id(6139866735338951)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6141039845338953)
,p_plug_template_id=>wwv_flow_imp.id(6139866735338951)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6141358856338953)
,p_plug_template_id=>wwv_flow_imp.id(6139866735338951)
,p_name=>'Sub Regions'
