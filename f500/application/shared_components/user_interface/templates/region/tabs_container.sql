...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6154878471338956)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6155149790338957)
,p_plug_template_id=>wwv_flow_imp.id(6154878471338956)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6155461735338957)
,p_plug_template_id=>wwv_flow_imp.id(6154878471338956)
,p_name=>'Tabs'
