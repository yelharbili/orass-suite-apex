...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6162539436338959)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6162895840338959)
,p_plug_template_id=>wwv_flow_imp.id(6162539436338959)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6163102397338959)
,p_plug_template_id=>wwv_flow_imp.id(6162539436338959)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6163453572338959)
,p_plug_template_id=>wwv_flow_imp.id(6162539436338959)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6163760098338959)
,p_plug_template_id=>wwv_flow_imp.id(6162539436338959)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6164057325338959)
,p_plug_template_id=>wwv_flow_imp.id(6162539436338959)
