...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6078408357338928)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6078761346338928)
,p_plug_template_id=>wwv_flow_imp.id(6078408357338928)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6079012803338928)
,p_plug_template_id=>wwv_flow_imp.id(6078408357338928)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6079307860338928)
,p_plug_template_id=>wwv_flow_imp.id(6078408357338928)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6079614511338928)
,p_plug_template_id=>wwv_flow_imp.id(6078408357338928)
,p_name=>'Sub Regions'
