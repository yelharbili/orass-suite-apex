...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6111717478338942)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6112045334338942)
,p_plug_template_id=>wwv_flow_imp.id(6111717478338942)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6112353806338942)
,p_plug_template_id=>wwv_flow_imp.id(6111717478338942)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6112674781338942)
,p_plug_template_id=>wwv_flow_imp.id(6111717478338942)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6112968174338942)
,p_plug_template_id=>wwv_flow_imp.id(6111717478338942)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6113211497338943)
,p_plug_template_id=>wwv_flow_imp.id(6111717478338942)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
