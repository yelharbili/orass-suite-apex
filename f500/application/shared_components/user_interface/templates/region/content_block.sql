...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6107190773338940)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6107401870338940)
,p_plug_template_id=>wwv_flow_imp.id(6107190773338940)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6107741482338940)
,p_plug_template_id=>wwv_flow_imp.id(6107190773338940)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6108035327338940)
,p_plug_template_id=>wwv_flow_imp.id(6107190773338940)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6108363454338940)
,p_plug_template_id=>wwv_flow_imp.id(6107190773338940)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6108648432338940)
,p_plug_template_id=>wwv_flow_imp.id(6107190773338940)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6108986092338940)
,p_plug_template_id=>wwv_flow_imp.id(6107190773338940)
,p_name=>'Sub Regions'
