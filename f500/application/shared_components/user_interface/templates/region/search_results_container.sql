...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6142329425338953)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6142620048338953)
,p_plug_template_id=>wwv_flow_imp.id(6142329425338953)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6142936270338953)
,p_plug_template_id=>wwv_flow_imp.id(6142329425338953)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6143287360338953)
,p_plug_template_id=>wwv_flow_imp.id(6142329425338953)
,p_name=>'Sub Regions'
