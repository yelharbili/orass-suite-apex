...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6137312908338951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6137633941338951)
,p_plug_template_id=>wwv_flow_imp.id(6137312908338951)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6137928263338951)
,p_plug_template_id=>wwv_flow_imp.id(6137312908338951)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6138255572338951)
,p_plug_template_id=>wwv_flow_imp.id(6137312908338951)
,p_name=>'Button Start'
