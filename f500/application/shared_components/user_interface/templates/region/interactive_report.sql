...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6135290417338950)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6135578874338950)
,p_plug_template_id=>wwv_flow_imp.id(6135290417338950)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6135885394338950)
,p_plug_template_id=>wwv_flow_imp.id(6135290417338950)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6136146933338950)
,p_plug_template_id=>wwv_flow_imp.id(6135290417338950)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6136437150338951)
,p_plug_template_id=>wwv_flow_imp.id(6135290417338950)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6136776977338951)
,p_plug_template_id=>wwv_flow_imp.id(6135290417338950)
,p_name=>'Sub Regions'
