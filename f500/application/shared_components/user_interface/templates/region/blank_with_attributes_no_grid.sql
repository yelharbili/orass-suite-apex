...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6079837657338929)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6080147673338929)
,p_plug_template_id=>wwv_flow_imp.id(6079837657338929)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6080424595338929)
,p_plug_template_id=>wwv_flow_imp.id(6079837657338929)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6080756687338929)
,p_plug_template_id=>wwv_flow_imp.id(6079837657338929)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6081037653338929)
,p_plug_template_id=>wwv_flow_imp.id(6079837657338929)
,p_name=>'Sub Regions'
