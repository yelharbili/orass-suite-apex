...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6085538079338931)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6085842168338931)
,p_plug_template_id=>wwv_flow_imp.id(6085538079338931)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6086183226338931)
,p_plug_template_id=>wwv_flow_imp.id(6085538079338931)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6086439469338931)
,p_plug_template_id=>wwv_flow_imp.id(6085538079338931)
,p_name=>'Sub Regions'
